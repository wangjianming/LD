...
<body>
	<div class="easyui-tabs" data-options="fit:true">
		<div title="属性" selected=true>
			<div style="position:absolute;left:2px;top:105px;font-size:14px;">基本信息</div>
			...
			<div style="position:absolute;left:2px;font-size:14px;top:155px;">权属信息</div>
			...
			<div style="position:absolute;left:2px;font-size:14px;top:205px;">非电配件</div>
			...
			<div style="position:absolute;left:2px;font-size:14px;top:255px;">电器件</div>
			<table style="position:absolute;left:40px;font-size:14px;top:250px;">
				<tr>
					<td align="right" width=90px>电容:</td>
					<td align="left"><input id="modelName" type="text"
						style="width:130px;" value="500uF" /></td>

					<td align="right" width=90px>光源1功率:</td>
					<td align="left"><input id="modelName" type="text"
						style="width:130px;" value="24W" /></td>

					<td align="right" width=90px>光源2功率:</td>
					<td align="left"><input id="modelName" type="text"
						style="width:130px;" value="0W" /></td>
			...
			<div style="position:absolute;left:2px;font-size:14px;top:290px;">照片信息</div>
			<table style="position:absolute;left:5px;font-size:14px;top:305px;">
				<tr>
					<td><img src="images/ludeng.jpg" width="750" height="550" />
					</td>
				</tr>
			</table>
		</div>
